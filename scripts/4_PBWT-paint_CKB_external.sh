#!/bin/bash
#SBATCH -A ckb.prj
#SBATCH -J ckbexternal_fs
#SBATCH -o ckbexternal_fs_%j.out
#SBATCH -e ckbexternal_fs_%j.err
#SBATCH -p long
#SBATCH -c 6
#SBATCH -a 1
...
bash ${programs}/finestructuregreedy.sh ${chunkcounts} ${finestructure_out}/sgdp_hgdp_1kGP_CKB.AllChr.AllChr.CKB_snps.GT.no_duplicates.rmdup.conformed.phased.newnames.maf_filter.relfree.local.all_CKB_external.greedy.xml
