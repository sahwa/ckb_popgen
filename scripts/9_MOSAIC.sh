...
ext_keep_pop_regex="Balochi|Mongolian|Chukchi|British|Tujia|Korean|Japanese|Cambodian|KinhVietnamese|Yakut"
...
Rscript ${programs}/MOSAIC/mosaic.R \
 --chromosomes 10:22 \
 --ancestries 2 \
 --panels "Balochi Mongolian Chukchi Yakut British Tujia Korean Japanese Cambodian KinhVietnamese" \
 --maxcores 4 \
 ${cluster} \
 ${mosaic_data}/
